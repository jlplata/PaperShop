...
namespace PaperShop.Reportes {
    ...
    public class ReporteCajas : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "PaperShop.Reportes.ReporteCajas.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedReporteCajas : Component, ICachedReport {
        
        public CachedReporteCajas() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ReporteCajas rpt = new ReporteCajas();
            rpt.Site = this.Site;
            return rpt;
        }
